...
The best way to reach me is via the WordPress.org support forum (https://wordpress.org/support/plugin/noshop/) for the plugin, or by opening an issue on the GitHub repository (https://github.com/dkguru/WP-Volunteer-Hours/issues).
